<?php
/**
 * Cornerstone Baptist Church - New Move In Visitation Volunteers (Password Protected)
 */
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="New Move In Visitation Volunteers - Cornerstone Baptist Church">
    <title>New Move In Visitation Volunteers | Cornerstone Baptist Church</title>
...
<body>
    ...
    <script>
        ...
        function downloadPDF() {
            ...
            // Header
            doc.setFontSize(18);
            doc.text('Cornerstone Baptist Church', 14, 20);
            doc.setFontSize(14);
