...
pages_dir = r'c:\Users\JoshuaDixon\Downloads\hbcbamban-site\pages'
...
NAV = """    <div class="top-bar"><div class="container"><div class="top-bar-content"><div class="top-bar-logo">
    <a href="../index.html"><img src="../images/Cornerstone.jpg" alt="Cornerstone Baptist Church Logo"></a>
    </div></div></div></div>
    <nav class="navbar"><div class="container"><div class="nav-wrapper">
        <div class="mobile-logo"><a href="../index.html"><img src="../images/Cornerstone.jpg" alt="Cornerstone Baptist Church Logo"></a></div>
        ...
        <ul class="nav-menu">
            ...
            <li class="dropdown"><a href="#">Media <i class="fas fa-chevron-down"></i></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="media-library.html">Cornerstone Media Library</a></li>
...
FOOTER = """    <footer class="footer"><div class="container"><div class="footer-content">
        <div class="footer-section"><h3>Cornerstone Baptist Church</h3><p>Sitio Magurul-gurol, Anupul, Bamban, Tarlac</p><p class="footer-tagline">A place you can call home.</p><div class="social-links"><a href="https://www.facebook.com/" target="_blank" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a></div></div>
        ...
        <div class="footer-section"><h4>Contact Us</h4><p><i class="fas fa-map-marker-alt"></i> Sitio Magurul-gurol, Anupul, Bamban, Tarlac</p><p><i class="fas fa-phone"></i> 09367777459 / 09928528704</p><p><i class="fas fa-envelope"></i> </p></div>
    </div><div class="footer-bottom"><p>&copy; 2026 Cornerstone Baptist Church of Sitio Magurul-gurol, Anupul, Bamban, Tarlac. All rights reserved.</p></div></div></footer>
...
<head>
    ...
    <meta name="description" content="{title} at Cornerstone Baptist Church, Philippines.">
    <title>{title} | Cornerstone Baptist Church</title>
    <link rel="icon" type="image/png" href="../images/Cornerstone.jpg">
    <link rel="apple-touch-icon" href="../images/Cornerstone.jpg">
    <link rel="manifest" href="../manifest.json">
    <meta name="theme-color" content="#14AFB1">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="apple-mobile-web-app-title" content="Cornerstone Baptist">
